<template>
    <di>
        <div class="flex space-x-6 mt-8 ml-20 mr-20">
            <div class="basis-1/2 bg-gray-200 rounded-lg py-6">
                <div class="ml-4">
                ...
                <p class="ml-4 mt-6">“PayBorda is incredibly user-friendly—navigating the platform is</p>
                <p class="ml-4">straightforward and hassle-free. We especially appreciate the ability to</p>
                <p class="ml-4">control and restrict certain actions based on employee access levels. It</p>
                <p class="ml-4 mb-10">gives us added peace of mind with an extra layer of security.”</p>

                <div class="flex ml-4 space-x-1">
                    <div><svg class="w-[23px] h-[23px] text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <p class="ml-4 mt-2">Landa Management Limited</p>
            ...
            <div class="basis-1/2 bg-gray-200 rounded-lg py-6">
                ...
                <p class="ml-4 mt-6">“We love that PayBorda allows us to have multiple wallets, including a</p>
                <p class="ml-4">dollar wallet, which makes managing our finances so much easier. The</p>
                <p class="ml-4 mb-16">instant payment feature is a game-changer too—it's fast and reliable!”</p>
                ...
                <p class="ml-4 mt-2">Rosella Nigeria</p>

            </div>

        </div>

        <div class="flex space-x-6 mt-6 ml-20 mr-20 mb-56">
            <div class="basis-1/2 bg-gray-200 rounded-lg py-4">
                <div class="ml-4">
                ...
                <p class="ml-4 mt-6">“As a small business owner working with international clients, PayBorda</p>
                <p class="ml-4">has completely transformed how I manage payments. I used to struggle</p>
                <p class="ml-4">with currency conversion fees and delays, but now, with features like Bid</p>
                <p class="ml-4">FX and the virtual foreign account, I can send and receive money</p>
                <p class="ml-4 mb-8">effortlessly. PayBorda is fast, reliable, and has saved me so much time!”</p>
                ...
                <p class="ml-4 mt-2">Mrs Chinwe, Cosmetics dealer</p>
            ...
            <div class="basis-1/2 bg-gray-200 rounded-lg py-4">
                ...
                <p class="ml-4 mt-6">“I recently hosted a virtual conference, and using PayBorda's Events &</p>
                <p class="ml-4">Ticketing feature was a breeze. Creating the event, selling tickets, and</p>
                <p class="ml-4">managing attendees—all in one place—was incredibly efficient. Plus, the</p>
                <p class="ml-4">option to get instant payments into my fiat wallet was a huge bonus. I</p>
                <p class="ml-4 mb-8">can't imagine using another platform for my events!”</p>
                ...
                <p class="ml-4 mt-2">Michael, Event Organizer

                </p>

            </div>
        </div>
        <p class="text-center text-5xl font-bold mb-6">Your Security, Our Priority</p>
        <p class="text-center">At PayBorda, safeguarding your account is our top priority, and here's</p>
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-20">
            <div class="basis-1/2">
                ...
                <p class="text-3xl font-bold mt-3 ml-5">2-Factor Authentication</p>
                <p class="mt-6 ml-5">Enable 2FA authentication to provide an extra layer of security to</p>
            ...
            <div class="basis-1/2">
                ...
                <p class="text-3xl font-bold mt-3">Licensed and Regulated</p>
                <p class="mt-6">Backed by our MSB license powered by Changera, along with other</p>
                <p class="">trusted licenses from our business partners, PayBorda operates</p>
                <p>under strict financial regulations to keep your money safe.</p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-20">
            <div class="basis-1/2">
                ...
                <p class="text-3xl font-bold mt-3">Data Encryption</p>
            ...
            <div class="basis-1/2">
                ...
                <p class="text-3xl font-bold mt-3">Dedicated Customer Support</p>
                <p class="mt-6">The in-app support team is always ready to assist you with any</p>
                <p class="">security concerns.</p>
            </div>
        </div>
